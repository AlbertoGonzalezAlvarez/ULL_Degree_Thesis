...
#         init_chromosome = Chromosome(selectedGensIndex= [GEN_STATE.SELECTED, GEN_STATE.SELECTED, GEN_STATE.REMOVED])
...
#             selectedGensIndex=[GEN_STATE.SELECTED, GEN_STATE.SELECTED, GEN_STATE.SELECTED, GEN_STATE.REMOVED])
#         EXPECTED_VALUE = 1
#
